<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="下载链接" prop="xiazailianjie">
          <el-input v-model="ruleForm.xiazailianjie" 
              placeholder="下载链接" clearable  :readonly="ro.xiazailianjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="下载链接" prop="xiazailianjie">
              <el-input v-model="ruleForm.xiazailianjie" 
                placeholder="下载链接" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiangguanshipin = true;
          ...
          if(o=='xiazailianjie'){
            this.ruleForm.xiazailianjie = obj[o];
	    this.ro.xiazailianjie = true;
            continue;
          }
          if(o=='faburiqi'){
